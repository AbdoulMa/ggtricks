...
You have a lot of functions to make sector charts where circle is split along its radii,
...
ggsave("man/figures/series_cricles_combination.png", width = 9.5, height = 6, dpi = 300, device = ragg::agg_png)
```

![Series of circles combination](man/figures/series_cricles_combination.png)
...
However, I will provide some tips to go through those restrictions on package website <https://www.abdoulma.github.io/ggtricks>
