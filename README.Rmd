...
Of course, y ou can choose, to customize the categories labels by setting `axis.text` in `theme_*()` function.   But the need can come to add labels at series of circles ending positions. There comes `geom_series_text()` functions.
