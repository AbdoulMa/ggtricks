...
Then come the `spotlight_cat` parameter to define the driving category. Also here you can combine the  `spotlight_cat` parameter value with `spotlight_position` to specify its position.
