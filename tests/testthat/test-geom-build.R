...
test_that("geoms build properly.", {
  expect_no_error(ggplot2::ggplot(test_df) + geom_pie(ggplot2::aes(cat = cat, val = val)))
  expect_no_error(ggplot2::ggplot(test_df) + geom_donut(ggplot2::aes(cat = cat, val = val)))
  expect_no_error(ggplot2::ggplot(test_df) + geom_slice(ggplot2::aes(cat = cat, val = val)))
  expect_no_error(ggplot2::ggplot(test_df) + geom_donut_slice(ggplot2::aes(cat = cat, val = val)))
})
